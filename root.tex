...
\item Fast Error Checking. Data invlove 2D and 3D, multiple perspective, fast guanrantee their consistency
\item  Easy Human-Computer interface, Field of view is large, the number of objects is large, 
\item  Easy for extension. there are a lot correlations among frames, areas, modality, annotation should be scalable and extensible
\end{enumerate}
...
\begin{enumerate}
	...
	\item developed an open-sourced 3D point annotation tool featuring  well-designed visualization and convenient operations.
	\item developed a series of functions such as auto-shrink, boundary-aware rotation and smart box initialization etc. to enable fast and accurate 3D box annotating.
	\item developed a novel registration-based inter-frame annotation transfer method.
...
\begin{table*}[]
	...
	\begin{tabular}{c||c|c|c|c|c|c||c|c|c|c|c}
		\hline
		\hline
		\multirow{2}{*}{} & \multicolumn{6}{c||}{Intelligent Function}                         & \multicolumn{5}{c}{Projective view}                 \\
		
		\cline{2-12}                        & Frame play  & Focus mode & Object color  & Box information & Camera switch & Auto-follow & Auto-shrink  & Boundary-aware rotation& Semi-auto annotation & Projective view operation& Automatic initial box generation \\  \hline
		...
		Supervise.ly~\cite{}       & $\surd$     &   $\times$ &   $\times$    &   $\surd$       &   $\times$    &  $\surd$    &     ++       &   ++     &   ++     &   ++     &   ++       \\ \hline
		
		playment.io~\cite{}       & $\surd$     &   $\times$ &   $\times$    &   $\surd$       &   $\times$    &  $\surd$    &     ++       &   ++     &   ++     &   ++     &   ++       \\ \hline
		
		scale.ai~\cite{}       & $\surd$     &   $\times$ &   $\times$    &   $\surd$       &   $\times$    &  $\surd$    &     ++       &   ++     &   ++     &   ++     &   ++       \\ \hline
...
\begin{table}[h]
	...
	\begin{tabular}{|l|c|c|c|c||c|c|c|c|}
		...
		\hline
		\hline
		Time/Object (sec.) & 18 & 55.2 $\pm$ 12.1\\
		\hline
		Undo/Object & - & 0.42 $\pm$ 0.43\\
		\hline
		Errors (Points/Object) & $<$0.5 & 28.7 $\pm$ 5.1\\
		\hline
		FP ratio / Object &  $<$0.5 & 7.16\%\\
		\hline
