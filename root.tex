...
\usepackage{amsmath,amssymb,graphicx,graphics,hyperref,subfigure,epstopdf,cite,enumerate,epstopdf,multirow,cleveref,gensymb,color}
\usepackage{multicol}
...
\begin{figure}
	...
	\begin{minipage}{0.2\linewidth}
		\centering
		\includegraphics[width=\textwidth]{./figures/rotate-fail}
	\end{minipage}\hfill
	~
	\begin{minipage}{0.2\linewidth}
		\centering
		\includegraphics[width=\textwidth]{./figures/rotate-success}
	\end{minipage}\hfill
	\caption{Boundary-aware-rotation}\label{fig:animals}
\end{figure}
