...
When we rotate the box, some interior points may go outside, but we want interior points being kept interior while the dimension and/or position being auto-adjusted. We emphasize that with this feature, to annotate an object is as easy as to enclose all points first and then rotate once.
